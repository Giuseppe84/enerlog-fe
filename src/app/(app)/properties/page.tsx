...
export default function page() {
  ...
  const loadProperties = async () => {
    try {
      ...
      const result = await fetchProperties(page, limit, query);
      console.log('Immobili caricati:', result);
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <PropertyFormModal open={open} setIsOpen={setOpen} property={null} setProperty={(property) => addProperty(property)} />
      </SidebarInset>
    </SidebarProvider>
