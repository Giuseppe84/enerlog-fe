...
export function OwnerStep({ form }: StepProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {!loading && subject && (
        <Card  onClick={() => setIsSubjectSelectorOpen(true)} className="p-4 flex items-start justify-between gap-4 cursor-pointer transition border
